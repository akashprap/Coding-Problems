<h2><a href="https://practice.geeksforgeeks.org/problems/modular-exponentiation-for-large-numbers5537/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Modular Exponentiation for large numbers</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Implement pow(x, n) % M.<br>
